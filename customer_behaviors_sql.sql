...
select gender, sum(purchase_amount) as revene from customer group by gender
...
select item_purchased, round(avg(review_rating::nmeric),2) as "Average product rating"
...
group by item_purchased order by disount_rate desc 
limit 5
--q7. segment customer into new, returning, and loyal based on thair total 
--number of previos purchases, and show the cont of each segment
...
select customer_segment, count(*) as "nmber of customers"
